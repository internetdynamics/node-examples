...
var cookieSession = require('cookie-session');           // Simplest form of durable session support (stored in a browser cookie)
...
// ---------------------------------------------------------------------------------
// Manage Sessions
app.use(cookieSession(config.cookie_session.config));
